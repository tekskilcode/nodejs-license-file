...
class LicenseFile {
    ...
    static parse(options, callback) {
        ...
        const isDefaultTemplate = typeof options.template !== 'string';
        const template          = isDefaultTemplate ? defaultTemplate : options.template;
        ...
        verify.update(isDefaultTemplate ? dataObj.data.string : JSON.stringify(dataObj.data));
        ...
        callback(null, {
            ...
            data: isDefaultTemplate ? dataObj.data.string : dataObj.data
        });
    }
