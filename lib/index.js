...
class LicenseFile {
    ...
    static generate(options, callback) {
        ...
        const serial = LicenseFile._generateSerial(options);
    ...
    static parse(options, callback) {
        ...
        options.fileParseFnc(options.fileData, (err, parsedData) => {
            ...
            const valid = verify.verify(fs.readFileSync(options.publicKeyPath, 'utf8'), parsedData.serial, 'base64');
    ...
    static _generateSerial(options) {
        ...
        const private_key = fs.readFileSync(options.privateKeyPath, 'utf8');
    ...
    static _defaultFileParseFnc(fileData, callback) {
        ...
        const data   = dataLines[1];
        const serial = dataLines[2];
